...
public class TwitterApp extends Application {
    ...
    public static TwitterClient getRestClient(Context context) {
        // getInstance() explained: return same instance of client when this static class called | https://www.quora.com/What-is-the-difference-between-new-getInstance-and-newInstance-in-java
